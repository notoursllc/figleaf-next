<script>
import { props, handlers, helpers, preparations, watchers } from './SliderService';
    ...
    computed: {
        sliderClasses() {
            return {
                ...
                'Slider--slideGrow': this.settings.slideGrow
            };
        },
...
.Slider__dots {
    @apply flex items-center whitespace-nowrap my-0 mx-auto;
}

.Slider__dot button {
    @apply block border-0 cursor-pointer rounded bg-gray-500;
    width: 1rem;
    height: .25rem;
    margin: 0 .25rem;
    font-size: 0;
