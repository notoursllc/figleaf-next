...
export const props = {
    props: {
        ...
        // flex-grow will be applied to slides if true
        slideGrow: {
            type: Boolean,
            default: false
        },
...
export const preparations = {
    methods: {
        ...
        prepareSlidesClasses() {
            ...
            if(this.slides[this.currentSlide + this.options.slidesToShow - 1]) {
                this.slides[this.currentSlide + this.options.slidesToShow - 1].classList.add('Slider__slide--last');
            }
            else {
                this.slides[this.currentSlide].classList.add('Slider__slide--last');
            }
